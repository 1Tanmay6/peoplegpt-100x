...
async def calculate_work_experience_score(work_experience: list, job_requirements: dict = None) -> dict:
    """
    ...
    analysis = await scorer.analyze_profile({'work_experience': work_experience}, 'experience', job_requirements)
