...
async def calculate_language_score(skill_data: dict, job_requirements: dict = None) -> dict:
    """
    ...
    analysis = await scorer.analyze_profile({'skill': skill_data}, 'skills', job_requirements)
