...
async def calculate_experience_adequacy(candidate_data: Dict[str, Any], role_level: str = 'entry') -> dict:
    """
    ...
    analysis = await scorer.analyze_profile(analysis_context, 'experience')
